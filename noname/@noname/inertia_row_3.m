...
t28 = -t27;
Irow = [t11+t13+t18+t28+t30+cos(q2).*(t2.*t29-t5.*t26).*(9.0./2.0e+1)-sin(q2).*(t2.*t26+t5.*t29).*(9.0./2.0e+1)+1.653561e+1,t11+t13+t18+t28+t30+1.653561e+1,t11+t13+t18+1.653561e+1,t11+t13+t18+7.8813e-1,t11+2.92005e-1,0.0];

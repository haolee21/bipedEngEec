...
Crow = [t9+t10+t11+t12+t13+t14+t15+qd1.*sin(q2+q3).*1.181061e+1+qd1.*sin(q2+t4).*1.6202025+qd1.*sin(q2+t5).*4.380075e-1,t9+t10+t11+t12+t13+t14+t15,t9,t9,t3.*(qd1+qd2+qd3+qd4+qd5).*(-4.380075e-1),0.0];

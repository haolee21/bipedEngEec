...
t147 = cmax.*t134.*t145;
t149 = (cmax.*t20.*t135.*t137.*t144)./2.0;
t150 = -t149;
t151 = t147+t148+t150;
t152 = (s.*t151)./2.0;
t153 = t146+t152;
dGrf_heel_c1_q1 = [(s.*(k.*t139.*(-t50+t61+t64+t136).*2.0+cmax.*t145.*(t72+t95+t112+t113+t130+qd_t1.*(t51+t128))-(cmax.*t20.*t137.*t144.*(t2.*(-9.201240000000001e-1)+t62+t63+t135))./2.0))./2.0+cmax.*s.*t21.*t132.*t145;(s.*(cmax.*t145.*(t72+t95+t112+t113+t130+qd_t1.*t128)+k.*t139.*(t61+t64+t136).*2.0-(cmax.*t20.*t137.*t144.*(t62+t63+t135))./2.0))./2.0+cmax.*s.*t21.*t129.*t145;t153;t153;(s.*(k.*t139.*(t100+t107+t119+t127).*2.0+cmax.*t145.*(t72+t95+qd_t1.*t93+qd_t2.*t93+qd_t3.*t93+qd_t4.*t93)-(cmax.*t20.*t137.*t144.*(t101+t106+t118+t126))./2.0))./2.0-cmax.*s.*t21.*t94.*t145;(s.*(cmax.*t145.*(t72+qd_t1.*t70+qd_t2.*t70+qd_t3.*t70+qd_t4.*t70+qd_t5.*t70)+k.*t139.*(t119+t127).*2.0-(cmax.*t20.*t137.*t144.*(t118+t126))./2.0))./2.0-cmax.*s.*t21.*t35.*t145.*4.60062e-1];

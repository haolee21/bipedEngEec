...
t41 = -t40;
t42 = t36+t41;
dGrf_heel_c4_q1 = [Fx.*(t27+t29+t34+t35+t38+qd_t1.*(t37+cos(q_t1).*4.60062e-1)).*(-1.0./2.0)+Fx.*t5.*(t13+t30+sin(q_t1).*4.60062e-1);Fx.*(t27+t29+t34+t35+t38+qd_t1.*t37).*(-1.0./2.0)+Fx.*t5.*(t13+t30);t42;t42;Fx.*(t27+t29+qd_t1.*t28+qd_t2.*t28+qd_t3.*t28+qd_t4.*t28).*(-1.0./2.0)+Fx.*t5.*(t18+t23);(Fx.*(t26+qd_t1.*t24+qd_t2.*t24+qd_t3.*t24+qd_t4.*t24+qd_t5.*t24))./2.0+Fx.*t5.*t23];

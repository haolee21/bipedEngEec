...
for i=1:size(ut,2)-2
    ...
    dL1 = [dL1_1((q2.'+q3.')/2,(q3.'-q2.')/sampT,sampT);...
           dL1_2((q2.'+q3.')/2,(q3.'-q2.')/sampT,sampT);...
           dL1_3((q2.'+q3.')/2,(q3.'-q2.')/sampT,sampT);...
           dL1_4((q2.'+q3.')/2,(q3.'-q2.')/sampT,sampT);...
           dL1_5((q2.'+q3.')/2,(q3.'-q2.')/sampT,sampT);...
           dL1_6((q2.'+q3.')/2,(q3.'-q2.')/sampT,sampT)]*sampT;
       
    dL2 = [dL2_1((q1.'+q2.')/2,(q2.'-q1.')/sampT,sampT);...
           dL2_2((q1.'+q2.')/2,(q2.'-q1.')/sampT,sampT);...
           dL2_3((q1.'+q2.')/2,(q2.'-q1.')/sampT,sampT);...
           dL2_4((q1.'+q2.')/2,(q2.'-q1.')/sampT,sampT);...
           dL2_5((q1.'+q2.')/2,(q2.'-q1.')/sampT,sampT);...
           dL2_6((q1.'+q2.')/2,(q2.'-q1.')/sampT,sampT)]*sampT;

...
%% INERTIA - Inertia matrix for the noname arm. 
% ========================================================================= 
%    
%    I = inertia(rob,q) 
%    I = rob.inertia(q) 
...
I = zeros(length(q)); 
I(1,:) = rob.inertia_row_1(q); 
I(2,:) = rob.inertia_row_2(q); 
I(3,:) = rob.inertia_row_3(q); 
I(4,:) = rob.inertia_row_4(q); 
I(5,:) = rob.inertia_row_5(q); 
I(6,:) = rob.inertia_row_6(q); 

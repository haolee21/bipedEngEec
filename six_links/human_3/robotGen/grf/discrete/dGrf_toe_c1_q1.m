...
t162 = (s.*t161)./2.0;
t163 = t156+t162;
dGrf_toe_c1_q1 = [(s.*(k.*t149.*(-t35+t60+t63+t147).*2.0+cmax.*t155.*(t89+t103+t110+t111+t141+qd1.*(t37+t139))-(cmax.*t20.*t145.*t154.*(t2.*(-9.0504e-1)+t61+t62+t146))./2.0))./2.0+cmax.*s.*t21.*t142.*t155;(s.*(cmax.*t155.*(t89+t103+t110+t111+t141+qd1.*t139)+k.*t149.*(t60+t63+t147).*2.0-(cmax.*t20.*t145.*t154.*(t61+t62+t146))./2.0))./2.0+cmax.*s.*t21.*t138.*t155;t163;t163;(s.*(k.*t149.*(t91+t99+t115+t127+t132+t134).*2.0+cmax.*t155.*(t89+t103+qd1.*t101+qd2.*t101+qd3.*t101+qd4.*t101)-(cmax.*t20.*t145.*t154.*(t90+t98+t114+t121+t130+t131))./2.0))./2.0+cmax.*s.*t21.*t100.*t155;(s.*(cmax.*t155.*(t89+qd1.*t86+qd2.*t86+qd3.*t86+qd4.*t86+qd5.*t86)+k.*t149.*(t115+t127+t132+t134).*2.0-(cmax.*t20.*t145.*t154.*(t114+t121+t130+t131))./2.0))./2.0+cmax.*s.*t21.*t85.*t155];

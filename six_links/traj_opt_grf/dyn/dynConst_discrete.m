...
%         
        ...
        gradceq(p.numJ+1:2*p.numJ,i,(i-1)*p.numJ+1:i*p.numJ) =eye(p.numJ)/4*p.sampT;
        gradceq(p.numJ+1:2*p.numJ,i+1,(i-1)*p.numJ+1:i*p.numJ) = 2*eye(p.numJ)/4*p.sampT;
        gradceq(p.numJ+1:2*p.numJ,i+2,(i-1)*p.numJ+1:i*p.numJ) = eye(p.numJ)/4*p.sampT;
        
        
        % gradient related to f_toe
        
        gradceq(:,i,(i-1)*p.numJ+1:i*p.numJ) = reshape(gradceq(:,i,(i-1)*p.numJ+1:i*p.numJ),[p.numJ*2+6,p.numJ])+dTau_toe(q1.',f_toe1.')/4*p.sampT;
        gradceq(:,i+1,(i-1)*p.numJ+1:i*p.numJ) = reshape(gradceq(:,i+1,(i-1)*p.numJ+1:i*p.numJ),[p.numJ*2+6,p.numJ])+2*dTau_toe(q2.',f_toe2.')/4*p.sampT;
        gradceq(:,i+2,(i-1)*p.numJ+1:i*p.numJ) = reshape(gradceq(:,i+2,(i-1)*p.numJ+1:i*p.numJ),[p.numJ*2+6,p.numJ])+dTau_toe(q3.',f_toe3.')/4*p.sampT;
        
        % gradient related to f_heel
        gradceq(:,i,(i-1)*p.numJ+1:i*p.numJ) = reshape(gradceq(:,i,(i-1)*p.numJ+1:i*p.numJ),[p.numJ*2+6,p.numJ])+dTau_heel(q1.',f_heel1.')/4*p.sampT;
        gradceq(:,i+1,(i-1)*p.numJ+1:i*p.numJ) = reshape(gradceq(:,i+1,(i-1)*p.numJ+1:i*p.numJ),[p.numJ*2+6,p.numJ])+2*dTau_heel(q2.',f_heel2.')/4*p.sampT;
        gradceq(:,i+2,(i-1)*p.numJ+1:i*p.numJ) = reshape(gradceq(:,i+2,(i-1)*p.numJ+1:i*p.numJ),[p.numJ*2+6,p.numJ])+dTau_heel(q3.',f_heel3.')/4*p.sampT;

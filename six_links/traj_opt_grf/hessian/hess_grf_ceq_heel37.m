function out1 = hess_grf_ceq_heel37(in1,toe_th,dmax,cmax,k,us,ud)
%HESS_GRF_CEQ_HEEL37
%    OUT1 = HESS_GRF_CEQ_HEEL37(IN1,TOE_TH,DMAX,CMAX,K,US,UD)

%    This function was generated by the Symbolic Math Toolbox version 8.4.
%    23-Jun-2020 11:20:49
...
t101 = tanh(t100);
out1 = (t101./2.0-1.0./2.0).*(cmax.*t18.*t99.*t102.*(t29.*4.38012e-1+t32.*4.5252e-1+cos(t31).*4.5252e-1)+cmax.*t18.*t84.*t99.*(t54.*4.38012e-1+t74.*4.5252e-1+t79.*4.5252e-1+t7.*t85.*7.65e-2-t13.*t86.*7.65e-2+t5.*(t43-t44).*4.38012e-1)+(cmax.*t18.^2.*t84.*t102.*(t97.^2-1.0).*(t27.*8.76024e-1+t34.*9.0504e-1-sin(t64).*5.529488670754286e-1))./2.0)-(cmax.*t18.*t84.*t99.*t102.*(t101.^2-1.0).*(t54.*1.752048e+2+t74.*1.81008e+2+t79.*1.81008e+2+t7.*t85.*(1.53e+2./5.0)-t13.*t86.*(1.53e+2./5.0)+t5.*(t43-t44).*1.752048e+2))./2.0;

function out1 = hess_grf_ceq_heel48(in1,toe_th,dmax,cmax,k,us,ud)
%HESS_GRF_CEQ_HEEL48
%    OUT1 = HESS_GRF_CEQ_HEEL48(IN1,TOE_TH,DMAX,CMAX,K,US,UD)

%    This function was generated by the Symbolic Math Toolbox version 8.4.
%    23-Jun-2020 10:10:47
...
t100 = tanh(t99);
out1 = (t100./2.0-1.0./2.0).*(cmax.*t18.*t98.*t101.*(t29.*4.38012e-1+t32.*4.5252e-1+cos(t31).*4.5252e-1)+cmax.*t18.*t83.*t98.*(t53.*4.38012e-1+t73.*4.5252e-1+t78.*4.5252e-1+t7.*t84.*7.65e-2-t13.*t85.*7.65e-2+t5.*(t42-t43).*4.38012e-1)+(cmax.*t18.^2.*t83.*t101.*(t96.^2-1.0).*(t27.*8.76024e-1+t34.*9.0504e-1-sin(t63).*5.529488670754286e-1))./2.0)-(cmax.*t18.*t83.*t98.*t101.*(t100.^2-1.0).*(t53.*1.752048e+2+t73.*1.81008e+2+t78.*1.81008e+2+t7.*t84.*(1.53e+2./5.0)-t13.*t85.*(1.53e+2./5.0)+t5.*(t42-t43).*1.752048e+2))./2.0;

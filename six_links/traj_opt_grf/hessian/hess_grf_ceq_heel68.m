function out1 = hess_grf_ceq_heel68(in1,toe_th,dmax,cmax,k,us,ud)
%HESS_GRF_CEQ_HEEL68
%    OUT1 = HESS_GRF_CEQ_HEEL68(IN1,TOE_TH,DMAX,CMAX,K,US,UD)

%    This function was generated by the Symbolic Math Toolbox version 8.4.
%    23-Jun-2020 10:04:28
...
t100 = tanh(t99);
out1 = (t100./2.0-1.0./2.0).*(cmax.*t18.*t83.*t98.*(t7.*t84.*7.65e-2-t13.*t85.*7.65e-2)+cmax.*t18.*t98.*t101.*cos(t31).*4.5252e-1-cmax.*t18.^2.*t83.*t101.*sin(t63).*(t96.^2-1.0).*2.764744335377143e-1)-(cmax.*t18.*t83.*t98.*t101.*(t100.^2-1.0).*(t7.*t84.*(1.53e+2./5.0)-t13.*t85.*(1.53e+2./5.0)))./2.0;

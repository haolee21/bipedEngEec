...
t9 = qd1.*t5.*1.25956;
t10 = qd2.*t5.*1.25956;
t11 = qd1.*t6.*3.4732e-1;
t12 = qd2.*t6.*3.4732e-1;
Crow = [t8+t9+t10+t11+t12+qd1.*sin(q2+t3).*1.354027+qd1.*sin(q2+t4).*3.73369e-1,t8+t9+t10+t11+t12,t8,t8,t2.*(qd1+qd2+qd3+qd4+qd5).*(-3.4732e-1)];

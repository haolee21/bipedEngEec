...
syms q1 q2 q3 q4 q5 th qd1 qd2 qd3 qd4 qd5 real;
...
matlabFunction(beta_grf,'file','grf/beta_grf','vars',[q1,q2,q3,q4,q5,th]);

matlabFunction(dbeta_dx1,'file','grf/dbeta_dx1','vars',[q1,q2,q3,q4,q5,th]);
matlabFunction(dbeta_dx2,'file','grf/dbeta_dx2','vars',[q1,q2,q3,q4,q5,th]);
matlabFunction(dbeta_dx3,'file','grf/dbeta_dx3','vars',[q1,q2,q3,q4,q5,th]);
matlabFunction(dbeta_dx4,'file','grf/dbeta_dx4','vars',[q1,q2,q3,q4,q5,th]);
matlabFunction(dbeta_dx5,'file','grf/dbeta_dx5','vars',[q1,q2,q3,q4,q5,th]);
